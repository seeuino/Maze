var MazeGenerator = function(rows, cols) {
  ...
  this.solve = function() {
    ...
    var targetCell = this.graph.getCellAt(this.graph.width - 30, this.graph.height - 1); // bottom right cell
      console.log(this.graph.width + ' ' + this.graph.height);
    ...
    while(openSet.length > 0) {
      ...
      if ( (searchCell.x == 14 && searchCell.y == 29) || (searchCell.x == 15 && searchCell.y == 29) || 
         (searchCell.x == 16 && searchCell.y == 29) || 
         
         
         (searchCell.x == 14 && searchCell.y == 28) || (searchCell.x == 15 && searchCell.y == 28) || 
         (searchCell.x == 16 && searchCell.y == 28) 
