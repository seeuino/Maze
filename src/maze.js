var Maze = function(doc, elemId) {
  ...
  self.ctx.fillStyle = "rgba(35, 183, 164, 0.5)";
  ...
  return {
    ...
    drawBorders: function() {
      ...
      this.drawLine(20, self.height, 300, self.height);
      this.drawLine(320, self.height, 580, self.height);
